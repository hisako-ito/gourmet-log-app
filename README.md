...
一般ユーザーは店舗の予約・更新・削除ができ、店舗代表者は店舗情報の作成・更新ができるアプリ  
管理者は店舗代表者の作成・お知らせメール送信ができる。
![グルメログアプリトップページ](https://github.com/user-attachments/assets/666ca47d-180b-4c0e-b0f8-0b4983ae5dd7)


## 作成した目的
　Laravelによるアプリケーション開発の学習のため
...
【管理者】
* 店舗代表者の作成
* 利用者(一般ユーザーと店舗代表者)にお知らせメール送信

【その他】
* 一般ユーザーが店舗を予約すると店舗側に見せるQRコードが発行され、店舗側は照合することができる
* 一般ユーザーに予約当日の朝に予約情報のリマインダーを送ることができる
